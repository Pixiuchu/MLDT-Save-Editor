...
mainWindow = Tk()
mainWindow.title("MLDT Save Editor v0.1.1")
...
def saveall(x):
    ...
    useself.saveflags(Flag_AbilityPage.owHammers, 0)
    useself.saveflags(Flag_AbilityPage.owHammerMini, 1)
    useself.saveflags(Flag_AbilityPage.owHammerMole, 2)
    useself.saveflags(Flag_AbilityPage.owSpinJump, 3)
    useself.saveflags(Flag_AbilityPage.owSideDrill, 4)
    useself.saveflags(Flag_AbilityPage.owBallHop, 5)
    useself.saveflags(Flag_AbilityPage.dwBButton, 7)
    useself.saveflags(Flag_AbilityPage.dwStack, 8)
    useself.saveflags(Flag_AbilityPage.dwStackGroundPound, 11)
    useself.saveflags(Flag_AbilityPage.dwStackSpingJump, 12)
    useself.saveflags(Flag_AbilityPage.dwCone, 9)
    useself.saveflags(Flag_AbilityPage.dwConeJump, 13)
    useself.saveflags(Flag_AbilityPage.dwConeTornado, 14)
    useself.saveflags(Flag_AbilityPage.dwBall, 10)
    useself.saveflags(Flag_AbilityPage.dwBallSlingshot, 15)
    useself.saveflags(Flag_AbilityPage.dwBallHammer, 16)
    useself.saveflags(Flag_AbilityPage.dwDrop, 17)
    useself.saveflags(Flag_AbilityPage.dwWallkick, 18)
    useself.saveflags(Flag_BattlePage.atkRedShell, 24)
    useself.saveflags(Flag_BattlePage.atkByeByeCannon, 30)
    useself.saveflags(Flag_BattlePage.atkBombDerby, 28)
    useself.saveflags(Flag_BattlePage.atkJetBoardBash, 29)
    useself.saveflags(Flag_BattlePage.atkZeeEgg, 33)
    useself.saveflags(Flag_BattlePage.atkGreenShell, 25)
    useself.saveflags(Flag_BattlePage.atkFireFlower, 27)
    useself.saveflags(Flag_BattlePage.atkDropchopper, 26)
    useself.saveflags(Flag_BattlePage.atkSlingsniper, 31)
    useself.saveflags(Flag_BattlePage.atkStarRocket, 32)
    useself.saveflags(Flag_BattlePage.atkLuiginaryBall, 34)
    useself.saveflags(Flag_BattlePage.atkLuiginaryStack, 35)
    useself.saveflags(Flag_BattlePage.atkLuiginaryHammer, 36)
    useself.saveflags(Flag_BattlePage.atkLuiginaryFlame, 37)
    useself.saveflags(Flag_BattlePage.atkLuiginaryWall, 38)
    useself.saveflags(Flag_BattlePage.atkLuiginaryTyphoon, 39)
    useself.saveflags(Flag_BattlePage.flagBrosAttack, 20)
    useself.saveflags(Flag_BattlePage.flagLuiginaryAttack, 21)
    useself.saveflags(Flag_BattlePage.flagItemBlocksBattle, 22)
    useself.saveflags(Flag_BattlePage.flagBadgesInBattle, 23)
